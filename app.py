...
interpreter = tf.lite.Interpreter(model_path="/home/piyush-anand/Desktop/SignSense-main/submission(1)/kaggle/working/model.tflite")
...
def get_display_message_from_api(recognised_words):
    # Load API key from environment variable or use hardcoded key (not recommended for production)
    GOOGLE_API_KEY = os.getenv("GOOGLE_API_KEY", "AIzaSyBTYkvh5YkdAL9XRus10wG1Vp-PSZlkhaA")
    
    # Gemini API endpoint
    url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent"
    
    # Construct the prompt (same as in your original function)
    prompt = f"""
        Objective:
    ...
    try:
        ...
        return "Error: Failed to generate sentence."
